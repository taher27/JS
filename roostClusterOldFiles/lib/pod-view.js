...
export default class PodView {
  ...
  serialize() {
    return {
      deserializer: 'PodView',
      uri: this.props.uri
    };
  }

  render() {
    var indexUrl = "atom://roostcluster/lib/podTable.html";
      return(
  ...
  getTitle() {
    return 'Workload Analytics';
  }

  isEqual(other) {
    return other instanceof PodView;
  }
